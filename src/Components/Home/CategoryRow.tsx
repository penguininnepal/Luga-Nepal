...
const CategoryRow = () => {
    ...
    const categories = [
        ...
        { name: "Kids", image: "https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?auto=format&fit=crop&q=80&w=600" },
                    ...
                    {categories.map((cat, idx) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center text-center p-4">
                                ...
                                <button className="bg-white text-black px-6 py-2 font-bold uppercase tracking-widest text-[10px] hover:bg-black hover:text-white transition-colors flex items-center gap-2 translate-y-4 group-hover:translate-y-0 duration-300 delay-75">
